...
/*   Updated: 2023/06/09 13:18:48 by alopez-g         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	render_scene(t_scene *s, int type)
{
	...
	draw_circle(img, (t_ivec2){100, 100}, 50, rbg_to_int(255, 50, 100));
	draw_circle(img, (t_ivec2){400, 100}, 50, rbg_to_int(255, 50, 100));
	draw_circle(img, (t_ivec2){240, 250}, 10, rbg_to_int(0, 0, 0));
	draw_circle(img, (t_ivec2){260, 250}, 10, rbg_to_int(0, 0, 0));
